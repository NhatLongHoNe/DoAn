...
namespace NidasShoes.Repository.Repository
{
    public class NCCRepository : INCCRepository
    {
        ...
        public async Task<NidasShoesResultEntity<bool>> AddOrUpdate(NCCEntity nCC)
        {
        ...
        public async Task<NidasShoesResultEntity<NCCEntity>> GetById(int Id)
        {
            var param = new DynamicParameters();
            param.Add("@Id", Id);
            var result = await _commonRepository.ListProcedureAsync<NCCEntity>("NidasShoes_get_NCC_byId", param);
            return result;
        }

        public async Task<NidasShoesResultEntity<NCCEntity>> GetListData(BaseParamEntity baseParam)
        {
            ...
            var res = await _commonRepository.ListProcedureAsync<NCCEntity>("NidasShoes_get_NCC", param);
