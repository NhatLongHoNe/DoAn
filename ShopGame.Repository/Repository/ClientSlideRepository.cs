...
{
    public class ClientSlideRepository : IClientSlideRepository
    {
        public ICommonRepository _commonRepository;
        public ClientSlideRepository(ICommonRepository commonRepository)
        {
            _commonRepository = commonRepository;
        }
        public async Task<ShopGameResultEntity<ClientSlideEntity>> GetListDataSlide(BaseParamEntity baseParam)
        {
            ...
            var res = await _commonRepository.ListProcedureAsync<ClientSlideEntity>("shopgame_get_banner", param);
